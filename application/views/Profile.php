  ...
  <body class="sidebar-light fixed-topbar theme-sltl bg-light-dark color-blue dashboard">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <input class="form-control" readonly required autocomplete="off" id="username" name="username" value="<?php echo $this->session->userdata('usernamechemical') ?>" />
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="col-sm-4 control-label">Display Name</label>
                          <div class="col-sm-8">
                            <input class="form-control form-white" required autocomplete="off" id="name" name="name" value="<?php echo $this->session->userdata('namechemical') ?>" />
                          </div>
                        </div>
                        <div class="form-group">
    ...
    <script>
          function myFunction() {
            ...
            if (x.value == "<?php echo $this->session->userdata('passwordchemical') ?>") {
