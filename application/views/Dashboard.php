							...
							<div class="panel panel-default">
								<div class="panel-body">
									...
									<div id="latest-images" class="owl-carousel owl-theme">
										<div class="item"><img class="img-thumbnail" src="<?php echo base_url();?>assets/img/gallery/Image001_tn.jpg" alt=""></div>
										<div class="item"><img class="img-thumbnail" src="<?php echo base_url();?>assets/img/gallery/Image002_tn.jpg" alt=""></div>
										<div class="item"><img class="img-thumbnail" src="<?php echo base_url();?>assets/img/gallery/Image003_tn.jpg" alt=""></div>
										<div class="item"><img class="img-thumbnail" src="<?php echo base_url();?>assets/img/gallery/Image004_tn.jpg" alt=""></div>
										<div class="item"><img class="img-thumbnail" src="<?php echo base_url();?>assets/img/gallery/Image005_tn.jpg" alt=""></div>
										<div class="item"><img class="img-thumbnail" src="<?php echo base_url();?>assets/img/gallery/Image006_tn.jpg" alt=""></div>
										<div class="item"><img class="img-thumbnail" src="<?php echo base_url();?>assets/img/gallery/Image007_tn.jpg" alt=""></div>
										<div class="item"><img class="img-thumbnail" src="<?php echo base_url();?>assets/img/gallery/Image008_tn.jpg" alt=""></div>
										<div class="item"><img class="img-thumbnail" src="<?php echo base_url();?>assets/img/gallery/Image009_tn.jpg" alt=""></div>
										<div class="item"><img class="img-thumbnail" src="<?php echo base_url();?>assets/img/gallery/Image010_tn.jpg" alt=""></div>
									</div>
								</div>
							</div>
						</div>
