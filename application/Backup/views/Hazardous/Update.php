              ...
              <form class="" method="post" action="<?php echo base_url().'Hazardous/Update/UpdateHazardous/'.$no?>" enctype="multipart/form-data">
                <div class="col-lg-12">
				         <div class="panel panel-default">
  								<div class="panel-heading" style="font-weight:bold"> <img src="<?php echo base_url();?>pictures/KBK Logo.png" alt="Logo" width="140px"> - Update Storing Requirement</div>
  								<div class="panel-body">
                    <div class="row">
                      <div class="col-lg-4">
                        <div class="form-group">
  												<label for="No">Hazardous No.</label>
  												<input required="on" type="text" id="No" name="No" autocomplete="off" class="form-control" value="<?php echo $hazard->No ?>">
  											</div>
                      </div>
                      <div class="col-lg-4">
                        <div class="form-group">
                          <label for="Name">Name</label>
                          <input required="on" type="text" id="Name" name="Name" autocomplete="off" class="form-control" value="<?php echo $hazard->Name ?>">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <select required="on" id="Storing_Tightly_Closed" name="Storing_Tightly_Closed" class="form-control">
                            <option value="N/R" <?php if($hazard->Storing_Tightly_Closed == "N/R"){ echo "selected = 'true'"; } ?>>N/R</option>
                            <option value="Yes" <?php if($hazard->Storing_Tightly_Closed == "Yes"){ echo "selected = 'true'"; } ?>>Yes</option>
                          </select>
  											</div>
                        <div class="form-group">
                          ...
                          <select required="on" id="Storing_Well_Ventilated" name="Storing_Well_Ventilated" class="form-control">
                            <option value="N/R" <?php if($hazard->Storing_Well_Ventilated == "N/R"){ echo "selected = 'true'"; } ?>>N/R</option>
                            <option value="Yes" <?php if($hazard->Storing_Well_Ventilated == "Yes"){ echo "selected = 'true'"; } ?>>Yes</option>
                          </select>
  											</div>
                        <div class="form-group">
                          ...
                          <select required="on" id="Storing_Away_Ignition" name="Storing_Away_Ignition" class="form-control">
                            <option value="N/R" <?php if($hazard->Storing_Away_Ignition == "N/R"){ echo "selected = 'true'"; } ?>>N/R</option>
                            <option value="Yes" <?php if($hazard->Storing_Away_Ignition == "Yes"){ echo "selected = 'true'"; } ?>>Yes</option>
                          </select>
  											</div>
                      </div>
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <select required="on" id="Storing_Locked_Up" name="Storing_Locked_Up" class="form-control">
                            <option value="N/R" <?php if($hazard->Storing_Locked_Up == "N/R"){ echo "selected = 'true'"; } ?>>N/R</option>
                            <option value="Yes" <?php if($hazard->Storing_Locked_Up == "Yes"){ echo "selected = 'true'"; } ?>>Yes</option>
                          </select>
                        </div>
                        <div class="form-group">
                          <label for="Storing_Dry_Cool">Dry Cool</label>
                          <select required="on" id="Storing_Dry_Cool" name="Storing_Dry_Cool" class="form-control">
                            <option value="N/R" <?php if($hazard->Storing_Dry_Cool == "N/R"){ echo "selected = 'true'"; } ?>>N/R</option>
                            <option value="Yes" <?php if($hazard->Storing_Dry_Cool == "Yes"){ echo "selected = 'true'"; } ?>>Yes</option>
                          </select>
                        </div>
                        <div class="form-group">
                          ...
                          <select required="on" id="Storing_Other" name="Storing_Other" class="form-control" onchange="Other()">
                            <option value="N/R" <?php if($hazard->Storing_Other == "N/R"){ echo "selected = 'true'"; } ?>>N/R</option>
                            <option value="Yes" <?php if($hazard->Storing_Other != "N/R"){ echo "selected = 'true'"; } ?>>Yes</option>
                          </select>
                        </div>
                      </div>
                      <div class="col-lg-4">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <input name="Incompabilities_Other_Chemical" id="Incompabilities_Other_Chemical" required="on" autocomplete="off" class="form-control" value="<?php echo $hazard->Incompabilities_Other_Chemical ?>">
                        </div>
                      </div>
                    </div>
                    <hr/>
    ...
    <script type="text/javascript">
      function Other() {
        ...
        if (Storing_Other == "Yes") {
          Other.innerHTML = '<label for="Name">Type Here..</label><input required="on" type="text" name="Other_Value" autocomplete="off" class="form-control" value="<?php echo $hazard->Storing_Other ?>">';
        }
        else {
          Other.innerHTML = "";
        }
      ...
      $(function() {
          $('#magicsuggest').magicSuggest({
            ...
            value: [
              <?php foreach ($Hazardous as $hazard): ?>
              <?php
                $temp = sizeof(explode(' ',$hazard->Incompabilities_Reg_Chemlist));
                $Incompabilities_Reg_Chemlist = "";
                for ($i=0; $i < $temp ; $i++) {
                  if ( $i == ($temp-1) ) {
                    $te = (string) explode(' ',$hazard->Incompabilities_Reg_Chemlist)[$i]; ?>
                    '<?php echo $te; ?>'
                  <?php }
                  else {
                    $te = (string) explode(' ',$hazard->Incompabilities_Reg_Chemlist)[$i]; ?>
